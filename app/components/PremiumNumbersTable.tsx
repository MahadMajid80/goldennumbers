            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {premiumNumbers.map((num, index) => (
                  <div
                    key={num._id}
                    className="bg-gray-800 rounded-lg p-6 border-2 border-[#FFD700] shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 cursor-pointer group animate-fade-in"
                    style={{
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                      ...
                      <div className="flex-shrink-0">
                        {num.price === "Price On Call" ? (
                          ...
                          <button 
                            onClick={openWhatsApp}
                            className="bg-black text-white px-6 py-3 rounded-full font-semibold hover:bg-gray-800 transition-all duration-300 group-hover:scale-105 shadow-lg"
                          >
                            {num.price}
                          </button>
                        )}
