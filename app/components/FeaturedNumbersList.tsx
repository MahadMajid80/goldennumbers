              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredNumbers.map((item) => (
                    <div
                      key={item._id}
                      className="bg-gray-800 rounded-lg px-4 py-3 md:px-5 md:py-5 flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4 hover:bg-gray-750 transition-all duration-300"
                    >
                      {/* Mobile Layout */}
